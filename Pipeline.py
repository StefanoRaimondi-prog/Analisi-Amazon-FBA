...
adattata alla struttura di progetto attuale.
"""
import os
import sys
import logging
...
def main():
    ...
    df_raw = Preprocessing.load_raw(raw_path)
    ...
    # 3. Statistiche descrittive e long-tail
